...
block_step_1 = [
    {
        ...
        "variables": {
            ...
            "mTokens_allocation": deposit_and_allocate_mTokens,
        },
    }
    for _ in range(10)
]
...
block_step_2 = [
    {
        ...
        "variables": {
            ...
            "mTokens_allocation": refund_and_clear_mToken_allocation
...
block_step_4 = [
    {
        ...
        "variables": {
            ...
            "mTokens_allocation": claimMTokens_clear_allocation,
            "mToken_balance": claimMTokens_debit_molten,
        },
    }
    for _ in range(10)
]
